...
-   **Group A:** eGFR 10-14
-   **Group B:** eGFR 5-7
-   _Before trial,<br> observational studies investigating this causal question showed a **strong survival advantage for late dialysis start**_
:::
...
# [TTE: Clone Censor Weight method]{style="color:navy;"}
...
-   If RCT?: All people not taking treatment at baseline <br> -\> _goes to same group_
-   If initiation occurs shorly after assignment to treatment <br> -\> _observation analogue roughly preserves key feature_

# [TTE: Multiple sequential trial]{style="color:navy;"}
